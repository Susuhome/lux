defmodule Lux.Lenses.Binance.MarketDataTest do
  ...
  test "fetches ticker price" do
    ...
    assert {:ok, %{symbol: "BTCUSDT", price: "50000.00"}} =
      MarketData.focus(%{endpoint: "ticker", symbol: "BTCUSDT", plug: {Req.Test, BinanceClientMock}})
  end
  ...
  test "fetches order book" do
    ...
    assert {:ok, %{bids: bids, asks: asks}} =
      MarketData.focus(%{endpoint: "depth", symbol: "BTCUSDT", limit: 10, plug: {Req.Test, BinanceClientMock}})
  ...
  test "fetches klines" do
    ...
    assert {:ok, %{klines: klines}} =
      MarketData.focus(%{endpoint: "klines", symbol: "BTCUSDT", interval: "1h", limit: 2, plug: {Req.Test, BinanceClientMock}})
  ...
  test "fetches 24h ticker stats" do
    ...
    assert {:ok, %{symbol: "ETHUSDT", price_change_percent: "2.50"}} =
      MarketData.focus(%{endpoint: "ticker_24h", symbol: "ETHUSDT", plug: {Req.Test, BinanceClientMock}})
  end
  ...
  test "handles API errors" do
    ...
    assert {:error, {400, "Invalid symbol."}} =
      MarketData.focus(%{endpoint: "ticker", symbol: "INVALID", plug: {Req.Test, BinanceClientMock}})
  end
end
